        ...
        <div class="container mx-auto px-5">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-0">
                <div class="footer-menu footer-logo">
                    <img src="@/assets/images/logo_copy.png" alt="TeknumConf logo" class="h-15">
                </div>
                <div class="footer-menu">
                    <h4 class="footer-menu-header">Menu</h4>
                    <ul class="list-none">
                        <li>
                ...
                <div class="footer-menu social-media">
                    ...
                    <ul class="list-none">
                        <li>
                            <a v-umami="{name: 'social-media-telegram'}" class="white" href="https://t.me/teknologi_umum_v2" target="_blank">
                        ...
                        <li>
                            <a v-umami="{name: 'social-media-github'}" class="white" href="https://github.com/teknologi-umum/" target="_blank">
                        ...
                        <li>
                            <a v-umami="{name: 'social-media-twitter'}" class="white" href="https://twitter.com/teknumconf/" target="_blank">
                        ...
                        <li>
                            <a v-umami="{name: 'social-media-youtube'}" class="white" href="https://www.youtube.com/@teknologiumum1227" target="_blank">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
